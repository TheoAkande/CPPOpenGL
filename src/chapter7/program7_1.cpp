...
void init(GLFWwindow* window) {
    renderingProgram = Utils::createShaderProgram("shaders/vert7_1.glsl", "shaders/frag7_1.glsl");
...
int program7_1(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(1200, 1000, "Chapter7 - program1", NULL, NULL);
