...
void init(GLFWwindow* window) {
    renderingProgram = Utils::createShaderProgram("shaders/vert4_3.glsl", "shaders/frag4_3.glsl");
...
int program4_3(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(1200, 1000, "Chapter4 - program3", NULL, NULL);
